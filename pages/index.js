...
export default function Home() {
  ...
  const apiCall = () => {
    axios({
      ...
      method: 'post',
      headers: {
        'x-hasura-admin-secret': process.env.NEXT_PUBLIC_DB_PASS
      },
      data: {
        query: `{
          pokemon_api_pokemon {
    ...
    <div className="container">
      <Layout home>
        ...
        <section className={utilStyles.headingMd}>
          ...
          <p>
            To query the API, click the button below and press Command Option J to open the console. Click on (151), then click [0-99] and [100-150] to view the data on the first 151 Pokemon!
        </p>
        </section>
        <div>
